<div class="modal-dialog modal-xl" role="document">
	<form action="{{ action('ClearanceController@customerDepositStore', $clearance->id) }}" id="storeQuotation" method="POST" enctype="multipart/form-data">
	@method('put')
		@csrf	
		 ...
		 <div class="row invoice-info">
		    <div class="col-sm-12 invoice-col">
		      <div class="form-group">
		      	...
		      	<input type="file" name="customer_deposit" id="customer_deposit" class="form-control">
		      	</div>		      		
		      </div>
		    </div>
		  </div>
