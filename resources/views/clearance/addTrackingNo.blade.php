<div class="modal-dialog modal-xl" role="document">
	<form action="{{ action('ClearanceController@addTrackingNoStore', $clearance->id) }}" id="storeQuotation" method="POST" enctype="multipart/form-data">
	@method('put')
		@csrf	
		 ...
		 <div class="row invoice-info">
		    <div class="col-sm-12 invoice-col">
		      <div class="form-group">
		      	...
		      	<div class="col-sm-8">
		      	<label for="payment">Tracking No.:</label>
