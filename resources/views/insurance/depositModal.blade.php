<div class="modal-dialog modal-xl" role="document">
	<form action="{{ action('InsuranceController@storeDeposit', $insurance->id) }}" id="storeDeposit" method="POST" enctype="multipart/form-data">
	@method('put')
		@csrf	
  <div class="modal-content">
    <div class="modal-header">
	    <button type="button" class="close no-print" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	    <h4 class="modal-title" id="modalTitle"> Insurance Services - Add Payment Proof(<b>(Reference No:</b> #{{ $insurance->id }})
	    </h4>
	</div>
