...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ action('OrderController@index') }}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>I</b>A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Import</b>Anything</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          @if (request()->user())
          <p>{{ request()->user()->name }}  {{ request()->user()->last_name }}</p>
          @endif
  ...
  <footer class="main-footer no-print">
    ...
    <strong>Copyright &copy; 2018 {{ config('app.name', 'QuedyProject') }}.</strong> 
    All rights reserved.
  </footer>
